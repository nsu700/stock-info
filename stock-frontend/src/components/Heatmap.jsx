...
function Heatmap() {
    ...
    useEffect(() => {
        ...
        // Add a cursor pointer to the leaf nodes to show they are clickable
        node.filter(d => d.depth === 2)
            .style("cursor", "pointer")
            // ✅ ADD THE CLICK EVENT HANDLER
            .on("click", (event, d) => {
                // Navigate to the detail page for the clicked stock
                navigate(`/stock/${d.data.symbol}`);
            });
